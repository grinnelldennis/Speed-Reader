...
public class SpeedReader {
	 ...
	 */
	public static void demonstratePanelCenter(WordGenerator w, int width, int height, int fontSize, 
	...
	/**
	 *  Instantiates panels and graphics library for displaying text
	 * @param w
	 * @param width
	 * @param height
	 * @param fontSize
	 ...
	 * @throws InterruptedException
	 */
	public static void demonstratePanelOffset(WordGenerator w, int width, int height, int fontSize, 
			int wpm) throws InterruptedException {
	...
	/**
	 *  Locates, center, and changes color of focus letter with each word 
	 * @param g
	 * @param s
	 * @param width
	 * @param height
	 ...
	 * @throws InterruptedException
	 */
	public static void focusLetter (Graphics g, String s, int width, int height, int wpm, int sW) 
			throws InterruptedException {
